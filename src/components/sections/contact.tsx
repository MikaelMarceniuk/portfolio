...
export function Contact() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-[1200px] flex flex-col items-center gap-6 text-center">
          <p
      ...
      <section id="contact" className="px-6 py-28">
        <div className="mx-auto max-w-[1200px] text-center">
          ...
          <a
            ...
            className="inline-block mt-4 font-mono text-lg transition-colors"
      ...
      <footer
        ...
        style={{ borderColor: 'var(--color-surface-border)' }}
      >
        <div className="mx-auto max-w-[1200px] flex flex-col items-center justify-between gap-4 sm:flex-row">
          <p
            className="font-heading text-sm font-semibold tracking-widest uppercase"
            style={{ color: 'var(--color-foreground)', letterSpacing: '0.15em' }}
          >
            Mikael
          </p>
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              <a
                ...
                onMouseLeave={(e) =>
                  ((e.currentTarget as HTMLElement).style.color = 'var(--color-foreground-muted)')
                }
              >
                <Icon size={16} />
              </a>
